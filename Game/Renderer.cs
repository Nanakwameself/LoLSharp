...
namespace LoLSharp.Game
{
    class Renderer
    {
        private static long ViewMatrix = OffsetManager.Instances.ViewMatrix;
        private static long ProjectionMatrix = ViewMatrix + 0x40;

        private const int Width = 0xC;
        private const int Height = 0x10;

        public static long Instance { get; } = Memory.ReadByPtr(OffsetManager.Instances.Renderer);
