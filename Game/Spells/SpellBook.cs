...
namespace LoLSharp.Game.Spells
{
    class SpellBook
    {
        public static long GetSpellBookInstance { get; } = Engine.GetLocalPlayer + OffsetManager.Instances.SpellBook;
        ...
        public static bool IsSummonerSpellReady(SummonerSpellSlot Slot)
        {
